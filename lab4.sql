...
INSERT INTO `backups` VALUES (1,'2019-12-25','09.50.244');
...
INSERT INTO `division` VALUES (1,'KGHejg');
...
CREATE TABLE `document` (
  ...
  PRIMARY KEY (`document_num`,`technics_technics_inventory_num`,`technics_Division_Division_num`),
...
INSERT INTO `technics` VALUES (1,'HFsfj','IFJIDs','2019-11-11',1);
...
CREATE TABLE `technics_repair` (
  `technics_repair_num` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `user` VALUES (1,'KFhs','2019-10-10','2019-10-16','kHGfsd','GKfhdg','GKdfhgh',1);
...
-- Dump completed on 2021-01-25  2:28:43
